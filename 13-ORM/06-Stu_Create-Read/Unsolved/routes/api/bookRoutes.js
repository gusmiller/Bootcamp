...
// This is the root API, by default retrieves all books
router.get('/', (req, res) => {
...
router.get('/paperbacks', (req, res) => {
    Book.findAll({
        // It determines the output order - we could use DESC for descending direction
        order: ['title'],
