...
departmentSchema.methods.getDocumentInfo = function () { //Cannot create an arrow function
...
const responseGetInstance = produce.get('totalStock', String); //The string determines the variable type return
console.log(
