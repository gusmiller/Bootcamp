...
describe('Arithmetic', () => {
  ...
  describe('difference', () => {
    ...
    it('should take two numbers find the difference', () => {
      const total = 0; // We are asserting that = 0
      const arithmetic = new Calculator(2, 2, "difference"); // We are implementing 
...
describe('Arithmetic', () => {
  ...
  describe('modulus', () => {
    ...
    // These few lines are repeated below 91 - 95 but we are including into one section
    ...
    // These few lines are repeated below 107 - 111 but we are including into one section
    it('should calculate 3 % 2 and return 1 as the remainder', () => {
      const total = 1;
      const arithmetic = new Calculator(3, 2, "modulus");
      expect(arithmetic.modulus()).toEqual(total);
